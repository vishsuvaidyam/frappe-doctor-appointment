<template>
    <div class="w-full px-5 sm:px-20 pt-10">
        <h1 class="text-2xl font-bold text-center text-gray-400">
            ABOUT <span class="text-md text-black">US</span>
        </h1>

        <div class="w-full flex flex-col sm:flex-row justify-center pt-10">
            <div class="w-full sm:w-1/3 mb-6 sm:mb-0">
                <img src="../assets/about_image-MG9zrc7b.png" class="w-full" />
            </div>
            ...
            <div class="flex justify-center">
                ...
                <div class="w-1/3 h-56 border flex items-center justify-center hover:bg-blue-600 group">
                    <div class="px-20">
                        ...
                        <p class="text-sm font-normal text-slate-500 group-hover:text-white"> Access to a network of
                            trusted healthcare
                ...
                <div class="w-1/3 h-56 border flex items-center justify-center hover:bg-blue-600 group">
                    <div class="px-20">
                        ...
                        <p class="text-sm font-normal text-slate-500 group-hover:text-white"> Tailored recommendations
                            and reminders to help
